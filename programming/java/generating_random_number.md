# :point_right: Generating Random Number
...
#### RandomNumberExample2.java <a id='example2'></a>
...
#### RandomNumberExample3.java <a id='example3'></a>
...
#### Using the ThreadLocalRandom Class <a id='thread-local-random'></a>
